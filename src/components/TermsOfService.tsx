      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p>
              By accessing and using EchoDesk ("the Service"), you accept and
          ...
          <section>
            ...
            <p>
              EchoDesk provides a comprehensive customer support and
              communication platform that enables businesses to manage customer
              interactions, support tickets, and communication channels. The
              Service may include various features such as messaging, call
              management, analytics, and integration capabilities.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Use the Service for any illegal purposes or in violation of any
                laws
              </li>
              ...
              <li>
                Resell, duplicate, or exploit any portion of the Service without
                permission
              </li>
          ...
          <section>
            ...
            <p className="mb-3">
              EchoDesk offers various subscription plans with different features
              and pricing:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
              ...
              <li>
                Failure to pay fees may result in suspension or termination of
                your account
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              We take the privacy and security of your data seriously. Your use
              of the Service is also governed by our Privacy Policy. We
              implement industry-standard security measures to protect your
              data, but cannot guarantee absolute security. You are responsible
              for maintaining the confidentiality of your data and access
              credentials.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              are owned by EchoDesk and are protected by international
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, EchoDesk shall not be
          ...
          <section>
            ...
            <p>
              ...
              the laws of the jurisdiction in which EchoDesk operates, without
          ...
          <section>
            ...
            <p>
              ...
              access or use our Service after revisions become effective, you
