...
type Platform = RecentConversation['platform']

// Platform icons as small badges
const PlatformIcon = ({ platform }: { platform: Platform }) => {
  const icons: Record<Platform, React.ReactNode> = {
    ...
    widget: (
      <svg className="h-3 w-3" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.486 2 2 5.823 2 10.5c0 2.674 1.458 5.06 3.737 6.62-.146 1.06-.55 2.227-1.44 3.342a.5.5 0 0 0 .53.79c1.94-.46 3.343-1.21 4.32-1.92.892.18 1.82.268 2.853.268 5.514 0 10-3.823 10-8.5S17.514 2 12 2Z"/>
      </svg>
    ),
  }
  ...
  const colors: Record<Platform, string> = {
    ...
    email: 'bg-[#475569] text-white',
    widget: 'bg-[#6366F1] text-white',
  }

  // Guard against any unexpected platform string from the API.
...
interface MessagesDropdownItemProps {
  conversation: RecentConversation
  onClick: () => void
}

export function MessagesDropdownItem({ conversation, onClick }: MessagesDropdownItemProps) {
