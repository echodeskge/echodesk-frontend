      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p className="mb-4">
              This Privacy Policy describes how EchoDesk ("we", "us", or "our") collects, uses,
              and shares your personal information when you use our service. This policy complies
              with the EU General Data Protection Regulation (GDPR) and other applicable data
              protection laws.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">1. Data Controller</h2>
            <p className="mb-3">
              EchoDesk is the data controller responsible for your personal information. You can
              contact us at:
            </p>
            <div className="pl-4 mb-3">
              <p>Email: <a href="mailto:privacy@echodesk.com" className="text-blue-600 hover:underline">privacy@echodesk.com</a></p>
              <p>Data Protection Officer: <a href="mailto:dpo@echodesk.com" className="text-blue-600 hover:underline">dpo@echodesk.com</a></p>
              <p>Address: [Company Address]</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Legal Basis for Processing</h2>
            <p className="mb-3">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2 mt-4">3.1 Information You Provide</h3>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <li><strong>Content:</strong> Any data you upload, share, or transmit through our service</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mb-2">3.2 Information Collected Automatically</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Usage Data:</strong> Features used, pages visited, time spent, interactions</li>
          ...
          <section>
            ...
            <p>
              ...
              When we transfer data outside the European Economic Area (EEA), we ensure appropriate
          ...
          <section>
            ...
            <p className="mt-3">
              Upon account deletion, we will delete or anonymize your data within 30 days, except
              where retention is required by law.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. Your Rights Under GDPR</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              To exercise these rights, contact us at <a href="mailto:privacy@echodesk.com" className="text-blue-600 hover:underline">privacy@echodesk.com</a>.
              We will respond within 30 days.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">9. Cookie Policy</h2>
            <p className="mb-3">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2 mt-4">Types of Cookies We Use:</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Essential Cookies:</strong> Required for the service to function properly</li>
              <li><strong>Performance Cookies:</strong> Help us understand how visitors use our service</li>
              <li><strong>Functional Cookies:</strong> Remember your preferences and settings</li>
              <li><strong>Marketing Cookies:</strong> Track your activity to deliver relevant advertisements (requires consent)</li>
            </ul>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">10. Security Measures</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              For significant changes, we will provide more prominent notice (such as email notification).
            </p>
          </section>
          ...
          <section>
            ...
            <div className="pl-4">
              <p>Email: <a href="mailto:privacy@echodesk.com" className="text-blue-600 hover:underline">privacy@echodesk.com</a></p>
              <p>Data Protection Officer: <a href="mailto:dpo@echodesk.com" className="text-blue-600 hover:underline">dpo@echodesk.com</a></p>
              <p>Support: <a href="mailto:info@echodesk.ge" className="text-blue-600 hover:underline">info@echodesk.ge</a></p>
