            ...
            {plans.map((plan) => (
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl">{t(`plans.${plan.name}.name`)}</CardTitle>
                  <CardDescription>{t(`plans.${plan.name}.description`)}</CardDescription>
                  <div className="mt-4">
                    ...
                    {pricingModel === 'crm' && 'users' in plan && (
                      <div className="text-sm text-muted-foreground mt-1">
                        {t('users')}: {plan.users === 'unlimited' ? t('unlimited') : plan.users}
                      </div>
                    )}
                  </div>
                </CardHeader>
