...
const NAMESPACES = ['bookingSettings', 'bookingsDashboard', 'bookingsServices', 'bookingsCategories', 'bookingsStaff', 'bookingsBookings', 'bookingsCalendar', 'bookingsAvailability'];
