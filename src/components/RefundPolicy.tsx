      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section>
            ...
            <p>
              Thank you for using EchoDesk. We strive to provide the best
              service possible. This refund policy outlines the terms and
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Service outage or technical issues preventing access for more
                than 48 consecutive hours
              </li>
              <li>Billing errors or duplicate charges</li>
              <li>
                Cancellation within the first 14 days of initial subscription
                (pro-rated refund)
              </li>
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>
                Provide a detailed explanation of why you are requesting a
                refund
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              ...
              7-10 business days. Refunds will be issued to the original payment
              method used for the purchase. Please note that it may take
              additional time for your financial institution to process the
              refund.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              to the service until the end of your current billing period. No
              refunds will be provided for the remaining time in your billing
              cycle unless otherwise specified under our refund eligibility
              criteria.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Your continued use of EchoDesk after any changes constitutes
